...
import { GroupMatches, GroupStanding, PoolMatches, PoolStanding, Team, TeamStanding } from "../behaviors/TournamentUtils";
...
const groupStandingData = {
  'Group-1': [
    { team: { name: 'Legend-2' }, matchPlayed: 2, matchPoint: 4, setPlayed: 5, earnedScore: 74, lostScore: 48 },
    { team: { name: 'Sports BD' }, matchPlayed: 2, matchPoint: 2, setPlayed: 4, earnedScore: 45, lostScore: 52 },
    { team: { name: 'Tarchera-6' }, matchPlayed: 2, matchPoint: 0, setPlayed: 5, earnedScore: 55, lostScore: 74 },
  ],
  'Group-2': [
    { team: { name: 'Tarchera-0' }, matchPlayed: 3, matchPoint: 6, setPlayed: 7, earnedScore: 104, lostScore: 80 },
    { team: { name: 'Ogose Wolves' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 94, lostScore: 78 },
    { team: { name: 'Tarchera-4' }, matchPlayed: 3, matchPoint: 2, setPlayed: 7, earnedScore: 82, lostScore: 101 },
  ],
  'Group-3': [
    { team: { name: 'Tarchera-0' }, matchPlayed: 3, matchPoint: 6, setPlayed: 7, earnedScore: 104, lostScore: 80 },
    { team: { name: 'Ogose Wolves' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 94, lostScore: 78 },
...
const groupMatches = {
  'Group-1': [
    { teams: [{ name: 'Sports BD' } as Team, { name: 'Legend-2' } as Team], winner: 1 },
    { teams: [{ name: 'Sports BD' } as Team, { name: 'Tarchera-6' } as Team], winner: 0 },
...
const poolStandingData = {
  'Pool A': {
    'Pool A-1': [
      { team: { name: 'Tarchera-1' }, matchPlayed: 3, matchPoint: 4, setPlayed: 8, earnedScore: 104, lostScore: 89 },
      { team: { name: 'Mars' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 92, lostScore: 81 },
      { team: { name: 'Legend-4' }, matchPlayed: 3, matchPoint: 4, setPlayed: 8, earnedScore: 97, lostScore: 96 },
      { team: { name: 'Legend-2' }, matchPlayed: 3, matchPoint: 0, setPlayed: 7, earnedScore: 73, lostScore: 100 },
    ],
    'Pool A-2': [
      { team: { name: 'Tarchera-0' }, matchPlayed: 3, matchPoint: 6, setPlayed: 7, earnedScore: 104, lostScore: 80 },
      { team: { name: 'Ogose Wolves' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 94, lostScore: 78 },
      { team: { name: 'Tarchera-4' }, matchPlayed: 3, matchPoint: 2, setPlayed: 7, earnedScore: 82, lostScore: 101 },
      { team: { name: 'Hotshots' }, matchPlayed: 3, matchPoint: 0, setPlayed: 7, earnedScore: 81, lostScore: 102 },
    ]
  },
  'Pool B': {
    'Pool B-1': [
      { team: { name: 'Tarchera-3' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 102, lostScore: 79 },
      { team: { name: 'Tarchera-2' }, matchPlayed: 3, matchPoint: 4, setPlayed: 7, earnedScore: 92, lostScore: 74 },
      { team: { name: 'Vai Vai' }, matchPlayed: 3, matchPoint: 2, setPlayed: 7, earnedScore: 87, lostScore: 96 },
      { team: { name: 'Sports BD' }, matchPlayed: 3, matchPoint: 2, setPlayed: 7, earnedScore: 70, lostScore: 102 },
    ]
  },
  'Pool C': {
    'Pool C-1': [
      { team: { name: 'Tarchera-6' }, matchPlayed: 3, matchPoint: 6, setPlayed: 6, earnedScore: 90, lostScore: 49 },
      { team: { name: 'Lazy Potato' }, matchPlayed: 3, matchPoint: 4, setPlayed: 6, earnedScore: 79, lostScore: 63 },
      { team: { name: 'Tarchera-7' }, matchPlayed: 3, matchPoint: 2, setPlayed: 6, earnedScore: 67, lostScore: 74 },
      { team: { name: 'Broken-Jet' }, matchPlayed: 3, matchPoint: 0, setPlayed: 6, earnedScore: 40, lostScore: 90 },
    ],
    'Pool C-2': [
      { team: { name: 'Tarchera-5' }, matchPlayed: 3, matchPoint: 6, setPlayed: 7, earnedScore: 99, lostScore: 72 },
      { team: { name: 'Legend-1' }, matchPlayed: 3, matchPoint: 4, setPlayed: 6, earnedScore: 79, lostScore: 79 },
      { team: { name: 'Bits and Bytes' }, matchPlayed: 3, matchPoint: 2, setPlayed: 7, earnedScore: 94, lostScore: 91 },
      { team: { name: 'Gunma lions' }, matchPlayed: 3, matchPoint: 0, setPlayed: 6, earnedScore: 60, lostScore: 90 },
    ],
  }
} as PoolStanding;
    ...
    standing.push(
      <div key={poolGroupName} className="group">
        ...
        <div className="group-data">
          ...
          {
            poolGroupStanding[poolGroupName].map((teamStanding: TeamStanding, index: number) => {
              return (
                <div key={index} className="group-data-content">
                  ...
                  <div>{getAPD(teamStanding.earnedScore, teamStanding.lostScore, teamStanding.setPlayed)}</div>
                </div>
              );
            })
          }
              ...
              groupMatches.map((match, index) => {
                return (
                  <ul key={index} className="matchup">
                    <li className={`team team-top ${match.winner === 0 && 'winner'}`}>{match.teams[0].name}</li>
                    <li className={`team team-bottom ${match.winner === 1 && 'winner'}`}>{match.teams[1].name}</li>
                  </ul>
                )
              })
            }
...
const DisplayAllPools = () => {
  ...
  poolNames.forEach((poolName, index) => {
    domElements.push(
      <DisplayIndividualPool key={poolName} poolName={poolName} openDetails={index === 0} />
    );
  });

...
export const SERVER_RECEIVER_BACKGROUND_CSS_CLASS =
  "server_receiver_background";
 ...
 */
export function getTeamIdOfGameWinner(
  team1Score: number,
  team2Score: number,
  noDeuce = false,
  ...
  if (!noDeuce && team1Score >= scoreToWin && team1Score - team2Score >= 2)
    return 1;
  if (!noDeuce && team2Score >= scoreToWin && team2Score - team1Score >= 2)
    return 2;
 ...
 */
export function determineServerAndReceiverPlayerIdByScore(
  score: number
): TeamOrPlayerId {
 ...
 */
export function determineNextServerAndReceiver(
  idOfTeamEarnedThePoint: TeamOrPlayerId,
  serverCurrentTeamId: TeamOrPlayerId,
  serverCurrentPlayerId: TeamOrPlayerId,
  ...
  if (serverCurrentTeamId === idOfTeamEarnedThePoint) {
    ...
    toBePlayerIdServerAndReceiver = determineServerAndReceiverPlayerIdByScore(
      idOfTeamEarnedThePoint === 1
        ? team1CurrentScore + 1
        : team2CurrentScore + 1
    );
  }
